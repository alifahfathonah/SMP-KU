...
$conn = mysqli_connect('localhost', 'id15778161_root', '!Masuk123456', 'id15778161_pendataan_siswa');
...
function login_validation($email, $password) {
  if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($email)) {
      ...
      set_flashdata('form_admin_error', 'isi field email terlebih dahulu dengan benar');

      return false;
    } else if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {

      // jika field email diisi selain dengan email yang valid
      set_flashdata('form_admin_error', 'bukan berupa format email yang valid');
...
function login($email, $password) {
  ...
  $result = query("SELECT * FROM admin WHERE email = '$email'")[0];
  ...
  if ($result) {
    ...
    */
    ...
    set_flashdata('form_admin_error', 'email atau password salah');
...
function tambah($data) {
  ...
  set_value($nama, $tanggal_lahir, $jenis_kelamin, $alamat, $tahun_ajaran, $nama_ibu, $tanggal_lahir_ibu, $nama_ayah, $tanggal_lahir_ayah, $kelas, $masuk_sekolah, $keluar_sekolah, $spp);
  
  if (!validation($nama, $tanggal_lahir, $jenis_kelamin, $alamat, $tahun_ajaran, $nama_ibu, $tanggal_lahir_ibu, $nama_ayah, $tanggal_lahir_ayah, $kelas, $masuk_sekolah, $keluar_sekolah, $spp)) {
    ...
    */
    ...
    // perintah query
    $query = "INSERT INTO data_siswa VALUES('', '$nama', '$tanggal_lahir', '$jenis_kelamin', '$alamat', '$tahun_ajaran', '$nama_ibu', '$tanggal_lahir_ibu', '$nama_ayah', '$tanggal_lahir_ayah', '$kelas', '$masuk_sekolah', '$keluar_sekolah', '$spp')";
...
function validation($nama, $ttl, $jk, $alamat, $tahun_ajaran, $ibu, $ttl_ibu, $ayah, $ttl_ayah, $kelas,  $masuk, $keluar, $spp) {
