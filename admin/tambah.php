        ...
        <div class="card-body">
          ...
          <form action="" method="post">
            <div class="form-group">
              ...
              <input type="text" name="nama" class="form-control" id="nama" placeholder="Name" autocomplete="off" value="<?= $_SESSION['value']['nama']; ?>">
            </div>
            <div class="form-group">
              <label for="tanggal_lahir"><small class="text-black-50">Tanggal lahir</small></label>
              <input type="text" name="ttl" class="form-control" id="tanggal_lahir" placeholder="Tanggal Lahir" autocomplete="off" value="<?= $_SESSION['value']['tanggal_lahir']; ?>">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="text" name="ttl_ibu" class="form-control" id="tanggal_lahir_ibu" placeholder="00/00/0000" autocomplete="off" value="<?= $_SESSION['value']['tanggal_lahir_ibu']; ?>">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="text" name="ttl_ayah" class="form-control" id="tanggal_lahir_ayah" placeholder="00/00/0000" autocomplete="off" value="<?= $_SESSION['value']['tanggal_lahir_ayah']; ?>">
            </div>
            <div class="form-group">
